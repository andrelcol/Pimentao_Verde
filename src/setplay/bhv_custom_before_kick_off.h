...
public:
    //! Pimentao_Verde: show "R" on field for this many cycles before going to formation
    static const int R_FORMATION_CYCLES = 90;
    //! Return position for unum to form letter "R" (Pimentao_Verde entrance)
    static rcsc::Vector2D getPimentaoVerdeRPosition( int unum );
    /*!
